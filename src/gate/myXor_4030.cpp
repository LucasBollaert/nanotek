...
#include "gateInclude/4030.hpp"

nts::Tristate nts::or4030::compute(std::size_t pin)
{
    switch (pin) {
        case 3:
            if ((this->compute(1) == nts::Tristate::TRUE && 
                this->compute(2) == nts::Tristate::FALSE) ||
                (this->compute(1) == nts::Tristate::FALSE && 
        ...
        case 4:
            if ((this->compute(5) == nts::Tristate::TRUE && 
                ...
                (this->compute(5) == nts::Tristate::FALSE && 
        ...
        case 10:
            if ((this->compute(9) == nts::Tristate::TRUE && 
                ...
                (this->compute(9) == nts::Tristate::FALSE && 
        ...
        case 11:
            if ((this->compute(12) == nts::Tristate::TRUE && 
                ...
                (this->compute(12) == nts::Tristate::FALSE && 
